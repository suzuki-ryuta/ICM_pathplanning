...
SRCS += Robot.cpp RRTTree.cpp Shape.cpp Square.cpp Wall.cpp LShape.cpp TaskSet.cpp Problem.cpp Controller.cpp pathsmooth.cpp pathshortcut.cpp TShape.cpp Triangle.cpp SpectralUtil.cpp GraphUtils.cpp clusters.cpp SpaceConfig.cpp 
# RRTStar.cpp InformedRRTStar.cpp
OBJS = $(SRCS:.cpp=.o)
